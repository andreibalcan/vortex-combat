    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutMasters", x => new { x.WorkoutId, x.MasterId });
                    table.ForeignKey(
                        name: "FK_WorkoutMasters_Masters_MasterId",
                        column: x => x.MasterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutStudents", x => new { x.WorkoutId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_WorkoutStudents_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutStudents_StudentId",
                table: "WorkoutStudents",
                column: "StudentId");
        }
